...
import docsConfig from '../../../site_config/service';
...
class Service extends Language {
...
document.getElementById('root') && ReactDOM.render(<Service />, document.getElementById('root'));
