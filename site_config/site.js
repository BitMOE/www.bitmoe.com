export default {
  ...
  domain: 'www.bitmoe.com', // 站点部署域名，无需协议和path等
  ...
  'zh-cn': {
    ...
    disclaimer: {
      title: '文化及愿景',
      content: '比特萌信息团队于2015年末开始筹建，企业字号“比特萌”中的“比特”取自计算机基本计量单位“比特”，寓意“信息”技术，另取《礼记·月令》“句者毕出,萌者尽达”中的“萌”字（萌芽之意），合并组成一个新词组；体现我司对于信息技术发展未来的信心及愿景。 \n 我公司秉承 信息 / 信用，通达未来。的企业经营理念，助力天下各市场主体强化自身信息职能，打赢未来信息战争。。。',
    },
    footerattention: {
      title: '关注我们',
      list: [
